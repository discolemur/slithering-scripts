...
do
	...
	echo "" >> $file.sh
	echo "#SBATCH --time=30:00:00   # walltime" >> $file.sh
	...
	echo "" >> $file.sh
	echo "/fslgroup/fslg_BybeeLab/scripts/nick/slithering-scripts/trinotate_minus_trinity.sh $file $file.gff" >> $file.sh
done
